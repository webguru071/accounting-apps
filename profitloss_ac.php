...
if(!$_SESSION['username'])
{
	...
	<div class="container no-print">
		<h2 class="heade-title">Profit/Loss Accounts</h2>
				...
				<div class="table-responsive">
					<table id="tabledit" class="table table-hover table-bordered">
						<thead>
							...
							<tr class="danger">
								<th colspan="22" class="text-center">Profit/Loss Accounts</th>
							</tr>
	...
	<script>
		...
		function viewData(){
			...
			$.ajax({
				url: 'include/profitloss_ac.php?p=view',
				method: 'GET'
			}).done(function(data){
				$('tbody').html(data);
			})
