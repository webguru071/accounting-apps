...
if(!$_SESSION['username'])
{
	...
	<div class="container no-print">
		<h2 class="heade-title">Trading Accounts</h2>
	</div>
	<div class="container no-print">
		<div class="row">
				...
				<div class="table-responsive">
					<table id="tabledit" class="table table-hover table-bordered">
						<thead>
							...
							<tr class="danger">
								<th colspan="22" class="text-center">Trading Accounts</th>
							</tr>
	...
	<script>
		...
		function viewData(){
			...
			$.ajax({
				url: 'include/trading_ac.php?p=view',
				method: 'GET'
			}).done(function(data){
				$('tbody').html(data);
			})
